        ...
        <div class="row justify-content-center">
            ...
            <article>
                <div class="col-12 text-center mt-3">
                    <h1 class="h1 fw-bold text-primary">Assignments</h1>
                </div>
                        ...
                        if (isset($_SESSION["teacher"])) {
                                ...
                                <div class="table-responsive">
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            $assignment_rs = Database::search("SELECT * FROM `assignments` WHERE `grade_has_subject_id`='" . $ghs_id . "'");
                                            ...
                                            for ($y = 0; $y < $assignment_count; $y++) {
                                                ...
                                                <tr class="border-bottom border-secondary">
                                                    ...
                                                    <td><a href="marks.php?id=<?php echo ($assignment_data["id"]); ?>"
                                                            class="btn btn-danger">Answers</a></td>
                                                </tr>
                                            ...
                                            <tr>
                                                <td colspan="8" class="text-center text-primary fs-5">
                                                    <div class="offset-2 offset-lg-4 col-8 col-lg-4 my-2 d-grid">
                                                        <a href="addAssignments.php" class="btn btn-primary">Add
                                                            Assignment</a>
                                                    </div>
                                                    ...
                                                    for ($y = 0; $y < $assignment_count; $y++) {
                                                        ...
                                                        <tr class="border-bottom border-secondary">
                                                            ...
                                                            <td>
                                                                ...
                                                                $sha_rs = Database::search("SELECT * FROM `student_has_assignments` WHERE `student_email`='" . $student["email"] . "' AND `assignments_id`='" . $assignment_data["id"] . "'");
                                                                $sha_count = $sha_rs->num_rows;

                                                                if ($date > $assignment_data["period"]) {
                                                                    if ($sha_count > 0) {
                                                                        ?>
                                                                        <button disabled class="btn btn-info">Submitted</button>
                                                                    <?php
                                                                    } else {
                                                                        ?>
                                                                        <button disabled class="btn btn-danger">Not Submitted</button>
                                                                    <?php
                                                                    }
                                                                } else {
                                                                    if ($sha_count > 0) {
                                                                        ?>
                                                                        <input type="file" accept="application/pdf, .zip, .7z, .docx"
                                                                            class="d-none form-control"
                                                                            id="upload<?php echo ($assignment_data["id"]); ?>" />
                                                                        <label class="btn btn-info"
                                                                            for="upload<?php echo ($assignment_data["id"]); ?>"
                                                                            onclick="upload_assignment(<?php echo ($assignment_data['id']); ?>, '<?php echo ($student['email']); ?>');">Re-upload</label>
                                                                    <?php
                                                                    } else {
                                                                        ?>
                                                                        <input type="file" accept="application/pdf, .zip, .7z, .docx"
                                                                            class="d-none form-control"
                                                                            id="upload<?php echo ($assignment_data["id"]); ?>" />
                                                                        <label for="upload<?php echo ($assignment_data["id"]); ?>"
                                                                            class="btn btn-info"
                                                                            onclick="upload_assignment(<?php echo ($assignment_data['id']); ?>, '<?php echo ($student['email']); ?>');">Upload</label>
                                                                    <?php
                                                                    }
                                                                }
                                                                ?>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                if ($sha_count > 0) {
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        ?>
                                                                        <a href="#" class="btn btn-danger disabled" disabled>Pending</a>
                                                                <?php }
                                                                } else {
                                                                    ?>
                            ...
                            for ($x = 0; $x < $aohs_count; $x++) {
                                ...
                                ?>
                                        ...
                                        <div class="col-12 mt-4 text-center d-grid">
                                            <button class="btn fs-4 text-warning fw-bold" type="button" data-bs-toggle="collapse"
                                                data-bs-target="#collapseExample<?php echo ($x) ?>" aria-expanded="false"
                                                aria-controls="collapseExample<?php echo ($x) ?>">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <?php echo ($assignment_data["period"]); ?>
                                                                        ...
                                                                        <td class="text-center"><a
                                                                                href="marks.php?id=<?php echo ($assignment_data["id"]); ?>"
                            ...
                            for ($x = 0; $x < $grade_count; $x++) {
                                ...
                                ?>
                                            ...
                                            <div class="col-12  mt-4 text-center d-grid collapsed">
                                                <button class="btn fs-4 text-warning fw-bold" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#c<?php echo ($x) ?>" aria-expanded="false"
                                                    aria-controls="c<?php echo ($x) ?>">
                                        <?php echo ($grade_data["grade"]); ?>
                                                </button>
                                                <hr />
                                            </div>
                                    ...
                                    for ($z = 0; $z < $ghs_count; $z++) {
                                        ...
                                        ?>
                                                <div class="collapse" id="c<?php echo ($x) ?>">
                                                    <div class="col-12 mt-3 p-3">
