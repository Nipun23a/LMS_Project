                        ...
                        <article class="col-12 p-3">
                            <div class="row justify-content-center">
                                ...
                                <section class="col-12 text-center">
                                    <h2 class="h2 fw-bold text-primary">Add Notes</h2>
                                </section>
                                ...
                                <section class="col-12 rounded-3 p-2 p-lg-3 bg-body">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-12 mb-4 mt-3">
                                            <label class="form-label  fs-5">Lesson Title</label>
                                        ...
                                        <div class="col-12 col-lg-6 text-center">
                                            <span class="fs-5 text-black-50">Please be kind to upload notes as PDFs often as
                                                possible</span>
                                        </div>
                                        ...
                                        <div class="col-10 col-lg-6 d-grid p-3">
                                            <button class="btn btn-success p-2 fs-5" onclick="release_note();">Release Note</button>
                                        </div>
