...
if (isset($_GET["grade"])) {
    ...
    if (isset($_SESSION["admin"])) {
        ...
        <select class="form-select" id="subject1">
            ...
            <optgroup label="<?php echo ($grade_data["grade"]) ?>">
                ...
                if ($gh_subject_count > 0) {
                    ...
                    for ($x = 0; $x < $gh_subject_count; $x++) {
                        ...
                        ?>
                        <option value="<?php echo ($gh_subject_data["id"]); ?>">
                    ...
                    ?>
                    <option>
                        <?php echo ("Something went wrong. System cannot find any relavant subjects reserved for the selected grade in the Database. Please contact Database Administrator"); ?>
                    </option>
                    <?php
