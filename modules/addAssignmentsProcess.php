    ...
    if ($count == sizeof($_FILES)) {
        ...
        for ($x = 0; $x < $count; $x++) {
            ...
            if (!in_array($file_ex, $allowed_file_extentions)) {
                ...
                if (!is_dir("shared/assignments/" . $subject)) {
                    // mkdir("shared/assignments/".$subject, 0600);
                    mkdir("shared/assignments/" . $subject, 0755);
                    // mkdir("shared/assignments/".$subject, 0777);
                }

                $file_name = "shared/assignments/" . $subject . "/" . $grade . "_" . uniqid("assignment_") . "_" . $title . $new_file_extention;
                ...
                Database::iud("INSERT INTO `assignments` (`path`,`time`,`title`,`grade_has_subject_id`,`teacher_email`,`period`) VALUES ('" . $file_name . "','" . $date . "','" . $title . "','" . $subject . "','" . $teacher["email"] . "','" . $deadline . " 00:00')");
                ...
                if (!isset($mail)) {
                    ...
                    $mailSubject = 'LMS New Assignment Alert';
                    $bodyContent = '<div style="padding: 3%; background-image: linear-gradient(90deg, #0d6efd 0%, #dc3545 100%);">
                                            ...
                                            <article style="background-color: hsl(170, 60%, 95%); opacity: 70%; padding: 4%; border-radius: 10%;"">
                                                <section style="letter-spacing: 0.1rem; font-size: 18px; padding: 2%;">
                                                    ...
                                                    <span>
                                                        <b>DeadLine:</b>
                                                        &nbsp;&nbsp;<br />' . $deadline . ' 00:00:00
                                                    </span><br /><br/>

                                                </section>
                                                <section style="font-size: 16px;">
                                                    <span>A new Assignment has been added by your teacher. Please check the Assignments section for the new Assignment.</span><br/><br/>
